...
public class AddSessionCategory {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddSessionCategory window = new AddSessionCategory();
	...
	private void initialize() {
		...
		JButton btnNewButton_12 = new JButton("View Session");
		...
		btnNewButton_14.setBounds(205, 482, 157, 41);
		panel_3.add(btnNewButton_14);
		
		JButton btnNewButton_15 = new JButton("View Session");
		btnNewButton_15.setFont(new Font("Times New Roman", Font.BOLD, 20));
		btnNewButton_15.setBackground(Color.CYAN);
		btnNewButton_15.setBounds(600, 482, 157, 41);
