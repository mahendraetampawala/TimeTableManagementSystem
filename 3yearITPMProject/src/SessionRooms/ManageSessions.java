...
public class ManageSessions {
	...
	private JTextField Lecturer1;
	private JTextField Lecturer2;
	private JTextField SubjectCode;
	private JTextField SubjectName;
	private JTextField StudentGroup;
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					//else {
							...
							String Lecture1=comboBoxSelectSession.getSelectedItem().toString();
							...
							SelectedSessions.setText(Lecturer1);
			             ...
			             //System.out.println(value);
		                	...
		                	Connection con = DBConnection.connect();
		                	 ...
		                	 String query = "INSERT INTO SessionRooms values('" + SID + "','" + Lecturer1 + "','" + Lecturer2 + "','" +
			                    		SubjectCode + "','" + SubjectName + "','" + StudentGroup + "','"+ Tag +"','"+ RoomName +"')";
		                    ...
		                    comboBoxSelectSession.setSelectedItem(SID);
